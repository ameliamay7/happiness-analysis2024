...
- Regional trend lines over time (East Asia, Latin America, Europe, etc.)
- Interactive choropleth map of global happiness by year
...
## Note
Interactive Plotly charts require running the notebook locally.
